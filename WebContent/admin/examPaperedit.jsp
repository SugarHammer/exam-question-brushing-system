			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="examPaperAction" action="examPaper" method="post">
						...
						<div class="form-group">
							 <label for="subjectNum" class="col-sm-2 control-label">题库数量</label>
							<div class="col-sm-5">
								<c:if test="${examPaper != null }">
									<input class="form-control" id="subjectNum" name="subjectNum" type="text" value="${examPaper.subjectNum }" placeholder="试卷中的题库总量" />
								</c:if>
								<c:if test="${examPaper == null }">
