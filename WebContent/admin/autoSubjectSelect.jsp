				...
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" action="../autoAddSubject">
						...
						<div class="form-group">
							 <label for="subjectSum" class="col-sm-2 control-label">题库数量</label>
							<div class="col-sm-10">
								<input class="form-control" name="subjectSum" id="subjectSum" type="text" placeholder="自动生成题库数量" />
							</div>
						</div>
						<div class="form-group">
