				...
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="studentRegSub" action="">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="form-control" name="studentAccount" id="account" type="text" placeholder="登录账户" />
							</div>
						</div>
						<div class="form-group">
							 <label for="pwd" class="col-sm-2 control-label">登录密码</label>
							<div class="col-sm-10">
								<input class="form-control" name="studentPwd" id="pwd" type="password" placeholder="登录密码" />
							</div>
						</div>
						<div class="form-group">
