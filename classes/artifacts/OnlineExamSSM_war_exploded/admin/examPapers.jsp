							...
							<tr class="subject_info">
								...
								<td>
									<div class="btn-group">
										...
										<button type="button" id="${ep.examPaperId }" class="btn btn-info btn-sm examPaper-subjects">查看题库</button>
										<button type="button" onclick="examPaperAddSubjects(${ep.examPaperId })" class="btn btn-info btn-sm">添加题库</button>
										<button type="button" onclick="autoAddSubjects(${ep.examPaperId })" class="btn btn-info btn-sm">生成题库</button>
									</div>
								</td>
							</tr>
						</c:forEach>
