			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="studentAction" action="student" method="post">
						...
						<div class="form-group">
							 <label for="studentAccount" class="col-sm-2 control-label">登录账户</label>
							<div class="col-sm-5">
								<input class="form-control" id="studentAccount" name="studentAccount" type="text" value="${student.studentAccount }" placeholder="学生登录账户" />
							</div>
						</div>
						<div class="form-group">
							 <label for="studentPwd" class="col-sm-2 control-label">登录密码</label>
							<div class="col-sm-5">
								<input class="form-control" id="studentPwd" name="studentPwd" type="password" value="${student.studentPwd }" placeholder="学生登录密码" />
							</div>
						</div>
						<br />
						<div class="form-group">
